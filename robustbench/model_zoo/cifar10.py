...
common_corruptions = OrderedDict([
    ...
    #     }),
    ('Standard_VITB', {
            'model': lambda: timm.create_model("vit_base_patch16_384", pretrained=False,checkpoint_path="/data/home/zhangrongyu/code/vida/cifar/pretrained/vit_base_16_384_imagenet1k_pre_cifar10.t7"),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
])
